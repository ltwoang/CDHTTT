...
class ObjectCounter(BaseSolution):
    ...
    def analyze_image_with_gemini(self, image_path, track_id):
        ...
        try:
            ...
            # Save Gemini result in a per-day + per-trackID .txt file
    ...
    def count_objects(self, current_centroid, track_id, prev_position, cls, im0, box):
        ...
        if crossed and direction:
            ...
            threading.Thread(target=self.analyze_image_with_gemini, args=(image_path, track_id)).start()
